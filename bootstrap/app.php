...
use App\Http\Middleware\JWTMiddleware as MiddlewareJWTMiddleware;
...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        $middleware->appendToGroup('jwt.auth', [MiddlewareJWTMiddleware::class]);
        $middleware->alias([
            'type' => TypesMiddleware::class
        ]);
    })
